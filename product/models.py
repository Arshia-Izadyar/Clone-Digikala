...
class Product(models.Model):
    category = models.ForeignKey(
        Category, verbose_name=_("Catergory"), on_delete=models.PROTECT, related_name="categories"
    )
    provider = models.ForeignKey(
        Provider, verbose_name=_("Provider"), on_delete=models.PROTECT, related_name="providers"
    )
...
class WishList(models.Model):
    user = models.ForeignKey(User, verbose_name=_("User"), on_delete=models.CASCADE, related_name="wishlists")
    product = models.ForeignKey(Product, verbose_name=_("Product"), on_delete=models.CASCADE, related_name="wishlists")
